jQuery(document).ready(function($) {
	...
	$('#asc').click(function(e){desc = false; sortIt(); e.preventDefault();});
	$('#desc').click(function(e){desc = true; sortIt(); e.preventDefault();});
	$('#clear').click(function(e){clearAll(1); e.preventDefault();});
